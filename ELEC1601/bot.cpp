...
void loop() {
  ...
  */
  ...
  if (irDetect(0, 38000) == 1 && irDetect(1, 38000) == 1 && irDetect(2, 38000) == 1) {
    Serial.println("Stopping");
    Stop();
  }
  else{
    if (irDetect(1, 39400) == 1 || irDetect(2, 42100) == 1) {
      // front wall detected
    ...
    else if (irDetect(0, 38000) == 1) {
        if (irDetect(2, 38000) == 0) {
          Serial.println("Turning right");
          Rturn(300);
        }
        else if (irDetect(1, 38000) == 0) {
          Serial.println("Turning left");
          Lturn(300);
        }
      }
